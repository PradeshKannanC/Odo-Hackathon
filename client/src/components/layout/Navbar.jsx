    ...
    <header className="flex items-center justify-between gap-3 bg-surface px-4 sm:px-6 py-4 border-b border-border/10">
      <div className="flex items-center gap-3 min-w-0">
        <button
          ...
          className="md:hidden text-text/70 hover:text-text transition-colors text-xl leading-none shrink-0"
        >
          ☰
        </button>
      ...
      <button
        ...
        aria-label="Search"
        className="flex-1 max-w-md hidden md:flex items-center gap-2 px-3 py-2 rounded-lg border border-border/10 text-text/45 hover:text-text/70 hover:border-border/20 transition-colors"
      >
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        <button
          ...
          onClick={openGlobalSearch}
          aria-label="Search"
          className="md:hidden text-text/70 hover:text-text transition-colors"
        >
        ...
        <button
          ...
          className="text-text/70 hover:text-text transition-colors text-lg leading-none"
        >
          {theme === "dark" ? "☀️" : "🌙"}
        </button>
